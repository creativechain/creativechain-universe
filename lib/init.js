...
const {Coin, CoinUri, ContentData, Notifications, Utils, File, Network, Trantor, CreativeCoin, FileStorage,
    DecodedTransaction, Author, MediaData, Comment, Like, PUBLICATION, Prices, Constants, OS, TorrentMsgCode} = require('./lib/trantor');
...
class Torrents {
    constructor() {
        this.worker = new Worker('./lib/torrent.js');
        this.callbacks = {};
    }
