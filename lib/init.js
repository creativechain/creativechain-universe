...
const {Utils, File, FileStorage, OS, DecodedTransaction, TransactionBuilder, Core, CoreConfiguration, RPCConfiguration} = creativechainCore;
...
const CONSTANTS = isDev ? CoreConstants.TestnetConstants : CoreConstants.MainnetConstants;
...
const trantor = new Core(new CoreConfiguration(CONSTANTS, null, null), TX_CONTENT_AMOUNT, TX_FEE_KB);
