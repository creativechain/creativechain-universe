...
trantor.events.on('onBeforePublish', function (txBuffer, mediaPost, txBuilder) {
            ...
            onclick: function () {
                sendTransaction(txBuffer.toString('hex'), walletPassword, function (err, result) {
                    if (err) {
                        ...
                        trantor.events.emit('onNotification', lang.ContentPublished, lang.ContentPublishedSuccessfully, './assets/img/publications1.png', 5);
                    }
                });
            }
        },
        ...
        getUserAddress(function (userAddress) {
            ...
            let onMakePublish = function () {
                ...
                if (featuredImage) {
                    ...
                    let destPublicPath = Constants.DATA_FOLDER + publishAddress + Constants.FILE_SEPARATOR;
                ...
                if (privateFile) {
                    ...
                    if (privateFile === featuredImage) {
                        ...
                        let destPrivatePath = Constants.DATA_FOLDER + publishAddress + '-p' + Constants.FILE_SEPARATOR;
...
function register() {
    ...
    getUserAddress(function (userAddress) {
        ...
        if (profileImage && profileImage.length > 0) {
            let destPath = Constants.DATA_FOLDER + userAddress + Constants.FILE_SEPARATOR;
...
function editArticle(article) {
    ...
    privateFile = editingArticle.private_file;
