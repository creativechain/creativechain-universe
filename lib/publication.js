...
trantor.events.on('onBeforeRegister', function (txBuffer, userReg, torrent) {
...
trantor.events.on('onDeSeedFile', function (torrent) {
    fileClient.remove(torrent, function (err) {
