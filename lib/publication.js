...
function publishContent() {
    ...
    trantor.publish(title, description, contentType, license, publishTags, featuredImage, privateFile, price)
}
...
function register() {
    ...
    trantor.register(username, email, web, description, profileImage, tags);
}
