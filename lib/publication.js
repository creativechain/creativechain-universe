...
trantor.events.subscribe('onRegister', 'public', function (txBuffer) {
    txBuffer = txBuffer[0];
    console.log('Event onRegister', txBuffer.toString('hex'));
});
...
/*        let imgCrop = $('#profile-crop').croppie({
            viewport: {
                width: 200,
                height: 200,
                type: 'square'
        ...
        imgCrop.croppie('result', 'html').then(function (html) {
            console.log('Crop html', html);
        })*/
    })
}