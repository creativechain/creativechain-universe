    ...
    let onUserAddress = function (userAddress) {
        trantor.getUserData(profileAddress, userAddress, function (err, result) {
            if (err) {
                    ...
                    if (!uiVueProfile) {
                        uiVueProfile = new Vue({
                            ...
                            data: {
                                profile: user,
                                lang: lang,
                                buzz: BUZZ.getBuzz(user.likes, user.comments, user.publications, user.followers)
                            },
                            methods: {
                        ...
                        uiVueProfile.$data.buzz = BUZZ.getBuzz(user.likes, user.comments, user.publications, user.followers);
                    }
                ...
                if (!user.avatarFile || !File.exist(user.avatarFile)) {
