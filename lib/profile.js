...
function loadUserFollowers(profileAddress, userAddress) {
    ...
    trantor.dbrunner.send('getFollowers', profileAddress, userAddress, function (err, result) {
        if (err) {
            console.log(err);
        } else {
...
function loadUserFollowings(profileAddress, userAddress) {
    trantor.dbrunner.send('getFollowing', profileAddress, userAddress, function (err, result) {
        if (err) {
            console.log(err);
        } else {
...
function loadAllUserMedia(authorAddress, add = false) {
    getUserAddress(function (userAddress) {
        trantor.dbrunner.send('getMediaByAuthor', authorAddress, userAddress, function (err, userPublications) {
            if (err) {
                console.error(err);
            } else {
