    ...
    trantor.database.getFollowers(profileAddress, userAddress, function (err, result) {
        if (err) {
            ...
            result.forEach(function (follower) {
                let id = 'follower-button-' + follower.follower_address;

                $('#' + id)
                    .unbind('click')
                    .attr('onmouseenter', "followButtonEnter('" + id + "', '" + profileAddress + "', " + follower.is_following + ")")
                    .attr('onmouseleave', "followButtonLeave('" + id + "', '" + profileAddress + "', " + follower.is_following + ")");
                makeFollowButton(id, follower.is_following);
            })
    ...
    trantor.database.getFollowing(profileAddress, userAddress, function (err, result) {
        if (err) {
            ...
            result.forEach(function (following) {
                let id = 'following-button-' + following.followed_address;

                $('#' + id)
                    .unbind('click')
                    .attr('onmouseenter', "followButtonEnter('" + id + "', '" + profileAddress + "', " + following.is_following + ")")
                    .attr('onmouseleave', "followButtonLeave('" + id + "', '" + profileAddress + "', " + following.is_following + ")");
                makeFollowButton(id, following.is_following);
            })
