...
const PUBLICATION = {};
PUBLICATION.START_BLOCK = isDev ? 53000 : 82200;
...
Constants.ASAR_FOLDER = global.appPath;
...
class Trantor {
            ...
            if (checksum) {
                ...
                if (File.exist(binaryFile)) {
                    ...
                    if (checksumBin === checksum) {
                        ...
                        console.log('Checksums not match');
                ...
                console.log('Checksum not found!!', content);
                if (!File.exist(binaryFile)) {
                    downloadDaemon();
                }
            }
    ...
    explore() {
        ...
        startBlock = startBlock < PUBLICATION.START_BLOCK ? PUBLICATION.START_BLOCK : startBlock;
        let that = this;
    ...
    register(userAddress, nick, email, web, description, avatar, tags) {
        ...
        setTimeout(function () {
            console.log('Author Torrent created!', avatar);
...
class Torrents {
    ...
    remove(torrent, callback) {
        this.torrentClient.remove(torrent, callback);
    }
}
