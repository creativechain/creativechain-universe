...
Constants.API_URL = 'https://invitations.creativechain.net/';
Constants.INVITATION_API = {
    LIST: Constants.API_URL + 'wallet/list',
    ADD: Constants.API_URL + 'wallet/add',
    CREDENTIALS: Constants.API_URL + 'oauth/v2/token'
};
