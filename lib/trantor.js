...
class Storage {
    ...
    getNotifications(callback, limit = 50) {
        this.query('SELECT * FROM Notification ORDER BY on_data DESC LIMIT ' + limit + ';', callback);
    }
    ...
    getUnviewedNotifications(callback, limit = 50) {
        this.query('SELECT * FROM Notification WHERE viewed = 0 ORDER BY on_data DESC LIMIT ' + limit + ';', callback);
    }
