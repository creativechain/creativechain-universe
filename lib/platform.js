...
function loadMediaItem(data, prepend = false) {
    ...
    articleLoader.load('./elements/content-item.html', function () {
        ...
        $('#content-item-tooltip-avatar-').attr('src', featuredImage.image);
        ...
        $('#content-item-tooltip-description-').html(data.web).attr('id', 'content-item-tooltip-description-' + data.address);
        $('#content-item-tooltip-email-').html(data.web).attr('id', 'content-item-tooltip-email-' + data.address);
...
function prepareArticle(address) {
    ...
    trantor.database.getMediaByAddress(address, function (err, result) {
        ...
        let crea = Coin.parseCash(preparedArticle.received_amount, 'CREA');
        $('#article-crea').html(crea.toFriendlyString());
...
function makePayment() {
    getUserAddress(function (address) {
        trantor.makeContentPayment(address, preparedArticle.address);
    })
}
