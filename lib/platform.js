...
function makePost(title, description, contentType, license, tags, publicFile, privateFile, price) {
    ...
    trantor.publish(userAddress, title, description, contentType, license, tags, publicFile, privateFile, price)
}
...
function prepareArticle(address) {
    ...
    trantor.database.getMediaByAddress(address, function (err, result) {
        ...
        if (preparedArticle.tags) {
            tags = preparedArticle.tags.join(', ');
        }
...
function makeLike() {
    if (!preparedArticle.user_liked) {
        console.log('makin like');
        let userAddress = localStorage.getItem('userAddress');
        trantor.makeLike(userAddress, preparedArticle.address);
    } else {
