...
<div id="notification-${notifId}" class="row border-notifications row-list-notification">
    <div class="row-list-notification-avatare cursor">
        <img id="notification-avatar-${notifId}" onclick="onLoadUser('${authorAddress}')" src="${avatar}" alt="" class="img-responsive img-circle-following img-center img-list-followers">
    </div>
