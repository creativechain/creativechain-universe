...
function showNotificationsView() {
    ...
    trantor.database.setViewedNotifications();
    prepareProfile();
    setBodyClass('page-profile edit-profile');
...
function showAboutModal() {
    ...
    let versionName = lang.VersionName;
    let appname = 'Creativechain Platform';
    let osname = OS.getPlatform() + ' ' + OS.getRelease();
    let arch = OS.getArch();
    let about = String.format(lang.AboutMessage, appname, version + ' ' + versionName, osname.capitalize() + ' ' + arch);
