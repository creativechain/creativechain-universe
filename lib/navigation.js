...
function prepareMain() {
    ...
    $("div[follow='icon']").addClass('icon-following-if-home')
        .removeClass('icon-following-if-menu-left')
}
...
function prepareProfile() {
    ...
    $("div[follow='icon']").removeClass('icon-following-if-home')
        .addClass('icon-following-if-menu-left')
}
