...
function showExploreView(filter  = '#ui-main-filter-following') {
    prepareMain();
...
function showProfileView(profileContent = '#ui-profile-posts', profileActiveFilter = '#ui-profile-filter-projects') {
    prepareProfile();
    showProfileHome(profileContent, profileActiveFilter);
    return false;
}

function showProfileHome(profileContent = '#ui-profile-posts', profileActiveFilter = '#ui-profile-filter-projects') {
...
function showNotificationsView() {
    ...
    prepareProfile();
    setBodyClass('page-profile edit-profile');
    showProfileHome('#ui-user-notifications', '#ui-profile-filter-notifications');
    page = PAGES.DISABLED;
    return false;
}

function showBlockedsView() {
    //$('#notifications-num').html(0);
    //TODO: Load Blockeds
    prepareProfile();
    setBodyClass('page-profile edit-profile');
    showProfileHome('#ui-user-blockeds', '#ui-profile-filter-blockeds');
    page = PAGES.DISABLED;
    return false;
}
